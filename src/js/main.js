...
(function() {
  var Amostra, EXAMES, Lote, add_amostra, add_lote, add_lote_amostra, getId, j, k, loteAberto, lotesEmProcesso, lotesProntos, m, n, o, processa_lote, resetStore, results, results1, results2, results3, results4,
  ...
  processa_lote = function() {
    ...
    results5 = [];
    for (p = 0, len = lotesEmProcesso.length; p < len; p++) {
      l = lotesEmProcesso[p];
