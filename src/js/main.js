...
(function() {
  var Amostra, EXAMES, Lote, add_amostra, add_lote, add_lote_amostra, getId, j, k, loteAberto, loteEmProcesso, lotesProntos, m, n, o, processa_lote, resetStore, results, results1, results2, results3, results4,
  ...
  processa_lote = function() {
    var l, len, p, results5;
    results5 = [];
    for (p = 0, len = loteEmProcesso.length; p < len; p++) {
      l = loteEmProcesso[p];
      if (l.status === 'PRONTO') {
        lotesProntos.push(l);
        results5.push(loteEmProcesso.pop(l));
      } else {
